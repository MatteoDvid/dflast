        ...
        <div className="glass-card-dark border border-white/15 rounded-2xl p-6 w-full max-w-md mx-auto shadow-2xl backdrop-blur-md">
          ...
          <div className="grid grid-cols-7 gap-1 mb-2">
            {['L', 'M', 'M', 'J', 'V', 'S', 'D'].map((day, i) => (
              <div key={`${day}-${i}`} className="h-8 flex items-center justify-center text-xs font-medium text-white/50">
                {day}
              </div>
            ))}
          </div>
  ...
  return (
    <NoSSRWrapper>
      <main className="relative w-full text-white min-h-[100dvh]">
        ...
        {result.status === 'idle' && (
          <div className="relative flex min-h-screen flex-col items-center justify-start px-6 pb-8">
            {/* Header */}
            <div className="text-center mt-24 md:mt-32 mb-6 md:mb-10">
              <h1 className="text-3xl md:text-5xl font-semibold mb-4 md:mb-6 font-airbnb leading-snug md:leading-relaxed">
                Personnalisez votre checklist<br />avec Don&apos;t Forget
              </h1>
              <p className="text-sm md:text-lg text-gray-300 font-airbnb leading-relaxed">
                ...
                {predefinedActivitiesForPopup.map((activity) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`w-6 h-6 rounded-full flex items-center justify-center ${isSelected ? 'bg-white text-gray-900' : 'bg-white/20'
                        }`}>
                        {isSelected ? (
